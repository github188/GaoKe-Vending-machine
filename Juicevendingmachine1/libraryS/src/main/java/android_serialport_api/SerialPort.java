...
public class SerialPort {
   ...
   public SerialPort(File device, int baudrate, int dataBits,int stopBits,char paritys) throws SecurityException, IOException {
      ...
      //  mFd = open(device.getAbsolutePath(), baudrate, flags);
       mFd = open(device.getAbsolutePath(), baudrate, dataBits,stopBits,paritys);
        if (mFd == null) {
